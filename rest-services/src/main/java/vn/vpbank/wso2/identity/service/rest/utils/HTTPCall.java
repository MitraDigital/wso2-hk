...
public class HTTPCall {
    ...
    public HTTPCall(String targetURL, String body, Map<String, List<String>> headers, Map<String, List<String>> query) {
    ...
    private void setupHeaders(HttpURLConnection connection, Map<String, List<String>> headers) {
        ...
        if (MDC.get("x-b3-traceid") != null) {
            connection.setRequestProperty("x-b3-traceid", MDC.get("x-b3-traceid"));
        }
        if (MDC.get("x-b3-spanid") != null) {
            connection.setRequestProperty("x-b3-spanid", MDC.get("x-b3-spanid"));
        }
        if (MDC.get("x-b3-parentspanid") != null) {
            connection.setRequestProperty("x-b3-parentspanid", MDC.get("x-b3-parentspanid"));
        }
    }
